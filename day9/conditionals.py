...
months = ['November', 'September', 'August', 'December', 'February', 
          'March', 'April', 'May', 'June', 'July', 'October', 'March', 'January']
...
# The following list contains some fruits:
    ...
    # to the list and print the modified list. If the fruit exists print('That fruit already exist in the list')
fruits = ['banana', 'orange', 'mango', 'lemon']
fruit = 'guava'
