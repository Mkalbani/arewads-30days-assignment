...
for language in countries:
    languages.update(countries(['languages']))
tot = len(languages)
print(tot)
...
new = list(languages)
most_spoken = Counter(new)
most_spoken_languages = most_spoken.most_common(10)
print(most_spoken_languages)

# Find the 10 most populated countries in the world
# Sort the list of dictionaries by population in descending order
sorted_countries = sorted(countries, key=lambda x: x['population'], reverse=True)
print("10 Most Populated Countries:")
for index, country in enumerate(sorted_countries[:10], start=1):
